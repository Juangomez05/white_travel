            ...
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <p><i class="fa fa-envelope mr-2"></i>info@whitetravel.com</p>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/carrusel_1.jpg" alt="Image"
                        style="max-height: 700px; max-width: 1700px">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Lo mejor de Popayán</h4>
                            <h1 class="display-3 text-white mb-md-4">En un solo lugar</h1>
                            <a href="{{ route('question1') }}" class="btn btn-primary py-md-3 px-md-5 mt-2" style="border-radius: 10px">¡Explora
                                ahora!</a>
                        </div>
                    </div>
                </div>
